<template>
  <div class="container">
    <div>
      <h1 class="title">Blacken Slash Privacy Policy</h1>

      <div class="text">
        <p>
          This page is used to inform visitors regarding my policies with the
          collection, use, and disclosure of Personal Information if anyone
          decided to use Blacken Slash.
        </p>

        <p>
          If you choose to use Blacken Slash, then you agree to the collection
        ...
        <h2>Log Data</h2>
        <p>
          I want to inform you that whenever you use Blacken Slash, in a case of
          ...
          the app when utilizing Blacken Slash, the time and date of your use of
        ...
        <p>This policy is effective as of 2020-09-24</p>

        <h2>Contact Us</h2>
        <p>
          If you have any questions or suggestions about my Privacy Policy, do
          not hesitate to contact me at ehmprah@gmail.com.
        </p>
      </div>
      <div class="footer">
        <Navigation />
...
export default {
  ...
  head() {
    return {
      title: 'Blacken Slash Privacy Policy'
    };
  }
};
</script>
